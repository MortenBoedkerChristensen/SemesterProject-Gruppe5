...
public class Recipe {
    ...
    public HashMap<String, Integer> getIngridients() { return ingridients; }
    ...
    public void setIngridients(HashMap<String, Integer> ingridients) { this.ingridients = ingridients; }

    // Resterende metoder
    public void addIngridient(String ingridient, int qty) { ingridients.put(ingridient, qty); }
    public void removeIngridient(String ingridient) { ingridients.remove(ingridient); }
    public int getIngridientQty(String ingridient) { return ingridients.get(ingridient); }
